...
`PDF Chatbot (RAG) — ingestion, embeddings, and conversational QA over PDF files using Hugging Face Hub + lightweight vector DB + deployable web UI.`

---    https://sanivarapu-bhavitha-pdfchatbot.streamlit.app/
